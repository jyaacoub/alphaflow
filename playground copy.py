...
import sys, os
sys.path.append('/home/jyaacoub/projects/def-sushant/jyaacoub/alphaflow')
os.chdir('/home/jyaacoub/projects/def-sushant/jyaacoub/alphaflow')
#%%
import argparse
...
from torch.distributed.fsdp.wrap import size_based_auto_wrap_policy, wrap, always_wrap_policy
...
with torch.no_grad():
    ...
    model = FSDP(model, 
                    ...
                    # limit_all_gathers=True, # only enabled in v2.0+
